...
function (_Component) {
  ...
  function Automobile(props) {
    ...
    var _this2$props = _this2.props,
        value = _this2$props.value,
        value2 = _this2$props.value2,
        onIncreaseClick = _this2$props.onIncreaseClick;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_10__["default"])(Automobile, [{
    ...
    value: function addcar(i) {
      console.log(this); // this.props.parent.getChildren(this, this.state.msg)

      var newaddnum = this.state.list[i].addnum += 1;
      var newmoney = this.state.list[i].number;
      var newprodata = this.state.value - newaddnum * newmoney; // this.props.value = this.value-(newaddnum*newmoney);
...
//# sourceMappingURL=index.js.c232d5d6ae91923fd2bb.hot-update.js.map